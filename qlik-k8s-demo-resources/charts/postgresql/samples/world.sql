...
CREATE SCHEMA world_cities;

CREATE TABLE world_cities.city (
    id integer NOT NULL,
...
CREATE TABLE world_cities.country (
    countrycode character(3) NOT NULL,
...
CREATE TABLE world_cities.countrylanguage (
    countrycode character(3) NOT NULL,
...
COPY world_cities.city (id, cityname, countrycode, district, citypopulation) FROM stdin;
...
COPY world_cities.country (countrycode, countryname, continent, region, surfacearea, indepyear, countrypopulation, lifeexpectancy, gnp, gnpold, localname, governmentform, headofstate, capital, code2) FROM stdin;
...
COPY world_cities.countrylanguage (countrycode, "language", isofficial, percentage) FROM stdin;
...
ALTER TABLE ONLY world_cities.city
    ADD CONSTRAINT city_pkey PRIMARY KEY (id);

ALTER TABLE ONLY world_cities.country
    ADD CONSTRAINT country_pkey PRIMARY KEY (countrycode);

ALTER TABLE ONLY world_cities.countrylanguage
    ADD CONSTRAINT countrylanguage_pkey PRIMARY KEY (countrycode, "language");

ALTER TABLE ONLY world_cities.country
    ADD CONSTRAINT country_capital_fkey FOREIGN KEY (capital) REFERENCES world_cities.city(id);

ALTER TABLE ONLY world_cities.countrylanguage
    ADD CONSTRAINT countrylanguage_countrycode_fkey FOREIGN KEY (countrycode) REFERENCES world_cities.country(countrycode);

COMMIT;

ANALYZE world_cities.city;
ANALYZE world_cities.country;
ANALYZE world_cities.countrylanguage;
